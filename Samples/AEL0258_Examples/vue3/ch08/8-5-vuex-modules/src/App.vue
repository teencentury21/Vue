...
export default {
    ...
    computed: {
        ...mapState({
            usdRate: state => state.rate_exchange.usdRate,
            jpnRate: state => state.rate_exchange.jpnRate,
        }),
        ...mapGetters('rate_exchange', [
            'usd', 'jpn'
        ]),
    },
    methods: {
        ...mapMutations('rate_exchange', [
            'updateNtd'
        ]),
        ...mapActions('rate_exchange', [
